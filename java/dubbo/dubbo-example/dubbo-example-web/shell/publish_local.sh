...
cp -r /data/github/study/java/dubbo-example/dubbo-example-web/target/dubbo-example-web.war /data/webservers/tomcat-9035-dubbo-example-web/webapps/ROOT.war
