...
public class UserAddressMySqlPlugin {
 
	public static void main(String[] args) throws IOException, XMLParserException {
		
        String configfile = "D:/mine/github/study/java/dubbo/mybatis-generator/src/main/resources/userAddress-generatorConfig.xml";
        ...
        Context context = config.getContext("userAddress");
