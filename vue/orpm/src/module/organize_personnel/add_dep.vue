...
<template>
  <div class="add-dep">
    ...
    <p class="add-dep-top">新增机构信息</p>
    <p class="add-dep-desc">在这里你可以新增下级机构信息。</p>
    <p class="add-dep-prompt">请在下方输入机构信息</p>
    <el-row :gutter="20" class="add-dep-row-boder" style="margin-left: 0;margin-right: 0;height: 100%;">
      <el-col :span="3" style="padding-left: 0;padding-right: 0;">
        <div class="grid-content bg-purple add-dep-text-right"><span>机构名称：</span></div>
      </el-col>
      <el-col :span="6" style="padding-left: 0;padding-right: 0;">
        <div class="grid-content bg-purple add-dep-text-left"><span><el-input v-model="depData.name" placeholder="请输入机构名称"></el-input></span></div>
      </el-col>
      <el-col :span="5" style="padding-left: 0;padding-right: 0;">
        <div class="grid-content bg-purple add-dep-text-right"></div>
      </el-col>
      <el-col :span="6" style="padding-left: 0;padding-right: 0;">
        <div class="grid-content bg-purple add-dep-text-left"></div>
      </el-col>
    </el-row>
    <el-row :gutter="20" class="add-dep-row-boder" style="margin-left: 0;margin-right: 0;height: 100%;">
      <el-col :span="3" style="padding-left: 0;padding-right: 0;">
        <div class="grid-content bg-purple add-dep-text-right"><span>机构简称：</span></div>
      </el-col>
      <el-col :span="6" style="padding-left: 0;padding-right: 0;">
        <div class="grid-content bg-purple add-dep-text-left"><span><el-input v-model="depData.shortname" placeholder="请输入机构简称"></el-input></span></div>
      </el-col>
      <el-col :span="5" style="padding-left: 0;padding-right: 0;">
        <div class="grid-content bg-purple add-dep-text-right"><span>机构负责人：</span></div>
      </el-col>
      <el-col :span="6" style="padding-left: 0;padding-right: 0;">
        <div class="grid-content bg-purple add-dep-text-left"><span><el-input v-model="depData.leader" placeholder="请输入机构负责人" @focus="selectLeader"></el-input></span></div>
      </el-col>
    </el-row>
    <el-row :gutter="20" class="add-dep-row-boder" style="margin-left: 0;margin-right: 0;height: 100%;">
      <el-col :span="3" style="padding-left: 0;padding-right: 0;">
        <div class="grid-content bg-purple add-dep-text-right"><span>机构类型：</span></div>
      </el-col>
      <el-col :span="6" style="padding-left: 0;padding-right: 0;">
        <div class="grid-content bg-purple add-dep-text-left"><span><el-select v-model="depData.departmenttype" placeholder="请选择">
		     <el-option
      ...
      <el-col :span="5" style="padding-left: 0;padding-right: 0;">
        <div class="grid-content bg-purple add-dep-text-right"><span>机构标识：</span></div>
      </el-col>
      <el-col :span="6" style="padding-left: 0;padding-right: 0;">
        <div class="grid-content bg-purple add-dep-text-left"><span><el-select v-model="depData.type" placeholder="请选择">
		    <el-option
  ...
  export default {
    ...
    methods: {
      selectLeader: function(){
          this.$store.dispatch("changeInitSelectedEmplyeeInfo", []);
